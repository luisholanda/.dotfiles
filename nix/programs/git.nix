...
rec {
  ...
  userName = "Luis Holanda";
  userEmail = "luiscmholanda@gmail.com";
  signing.key = "DA2223669494475C";
  ...
  aliases = {
    ...
    lt = "log --topo-order";
    ll =
      "log --graph --topo-order --date=short --abbrev-commit --decorate --all --boundary --pretty=ormat:'%Cgreen%ad %Cred%h%Creset -%C(yellow)%d%Creset %s %Cblue[%cn]%Creset %Cblue%G?%Creset'";
    lll =
