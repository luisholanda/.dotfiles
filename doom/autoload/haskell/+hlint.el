;;; ~/.config/doom/autoload/haskell/+hlint.el -*- lexical-binding: t; -*-
;;; Commentary:
...
(defun hlint-refactor-call-process-region-checked
    (start end program &optional args)
...
(defun hlint-refactor-call-process-region-preserve-point
    (start end program &optional args)
